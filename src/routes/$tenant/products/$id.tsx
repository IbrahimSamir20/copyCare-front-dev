...
import ProductForm from './-components/components/ProductForm.tsx';
import { productQueryOptions } from './-components/queries/product.query.ts';
import { useSuspenseQuery } from '@tanstack/react-query';
import { actionEnum } from '@/common/const/actionEnum';
import { routesEnum } from '@/common/const/routesEnum';
import MainWrapper from '../-components/MainWrapper.tsx';

export const Route = createFileRoute('/$tenant/products/$id')({
  beforeLoad: (opt) => {
